import {
  ...
  useFormControl
} from "./chunk-OCF24V26.js";
import {
  createSvgIcon,
  init_utils
} from "./chunk-NCVFBDAC.js";
import {
  LocalizationProvider,
  PickerAdapterContext
} from "./chunk-JRPIE3FK.js";
import {
  alpha,
  useMediaQuery,
  useTheme,
  useThemeProps
} from "./chunk-3YY2NTJV.js";
import {
  CacheProvider,
  Global,
  StyleSheet,
...
var useLocalizationContext = () => {
  const localization = React12.useContext(PickerAdapterContext);
...
var useParsedFormat = (parameters = {}) => {
  ...
  const localizedDigits = React15.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const {
...
var PickerPopperPaperWrapper = React25.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
var useControlledValue = ({
  ...
  const inputTimezone = React30.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React30.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  const viewValue = React31.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var PickersActionBar = React33.memo(PickersActionBarComponent);
if (true)
...
var PickersLayout = React36.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime12.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime12.jsxs)(React36.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime12.jsxs)(React36.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime13.jsxs)(React38.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime13.jsxs)(React38.Fragment, {
  children: [(0, import_jsx_runtime13.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime13.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersSectionList = React39.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime14.jsx)(React39.Fragment, {
...
var PickersOutlinedInput = React43.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime17.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime17.jsxs)(React43.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
function useTheme2(defaultTheme4 = null) {
  const contextTheme = React44.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React46.forwardRef(function Box3(inProps, ref) {
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React47.useLayoutEffect : React47.useEffect;
...
var PropsContext = React52.createContext(void 0);
...
function useLayerOrder(theme) {
  ...
  return (0, import_jsx_runtime22.jsx)(GlobalStyles_default, {
    styles: layerOrder
  });
}
  ...
  return (0, import_jsx_runtime23.jsx)(ThemeProvider_default, {
    ...
    children: (0, import_jsx_runtime23.jsx)(ThemeContext.Provider, {
      ...
      children: (0, import_jsx_runtime23.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime23.jsxs)(DefaultPropsProvider_default, {
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React60.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const Grid2 = React61.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime27.jsx)(GridRoot, {
      ...
      children: React61.Children.map(children, (child) => {
        var _a;
        if (React61.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React62.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React62.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var PickersFilledInput = React63.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var PickersInput = React64.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React65.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React65.useMemo(() => _extends({}, fieldOwnerState, {
...
var PickerFieldUIContext = React66.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const translations = usePickerTranslations();
  const pickerContext = useNullablePickerContext();
  const pickerFieldUIContext = React66.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!((_a = textFieldProps.InputProps) == null ? void 0 : _a.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    textFieldProps.InputProps.startAdornment = (0, import_jsx_runtime32.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
  ...
  if (!((_b = textFieldProps.InputProps) == null ? void 0 : _b.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    textFieldProps.InputProps.endAdornment = (0, import_jsx_runtime32.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime33.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime33.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime33.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime33.jsx)(PickerPopper, {
        slots,
        slotProps,
        children: (0, import_jsx_runtime33.jsx)(Layout, _extends({}, slotProps == null ? void 0 : slotProps.layout, {
          slots,
          slotProps,
...
var useFieldState = (parameters) => {
  ...
  const error = React70.useMemo(() => {
    if (errorProp !== void 0) {
      return errorProp;
    }
    return hasValidationError;
  }, [hasValidationError, errorProp]);
  const localizedDigits = React70.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React70.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  const getSectionsFromValue = React70.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    adapter,
    localeText: translations,
    localizedDigits,
    format,
  ...
  const parsedSelectedSections = React70.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  const activeSectionIndex = parsedSelectedSections === "all" ? 0 : parsedSelectedSections;
  const sectionOrder = React70.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const areAllSectionsEmpty = React70.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React70.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React71.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React71.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React72.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React73.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React73.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React74.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React74.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React75.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React75.useMemo(() => ({
  ...
  const elements = React75.useMemo(() => {
  ...
  React75.useImperativeHandle(unstableFieldRef, () => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel3(value);
  const sections = React76.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React76.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React76.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React76.useEffect(() => {
  ...
  const inputMode = React76.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
  ...
  React76.useImperativeHandle(unstableFieldRef, () => ({
    getSections: () => state.sections,
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React77.useMemo(() => internalProps.ampm ?? adapter.is12HourCycleInCurrentLocale(), [internalProps.ampm, adapter]);
  return React77.useMemo(() => _extends({}, internalProps, validationProps, {
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React78.useMemo(() => internalProps.ampm ?? adapter.is12HourCycleInCurrentLocale(), [internalProps.ampm, adapter]);
  return React78.useMemo(() => _extends({}, internalProps, validationProps, {
...
var DateField = React79.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
  ...
  return (0, import_jsx_runtime34.jsx)(PickerFieldUI, {
    slots,
    slotProps,
    fieldResponse,
...
var useIsDateDisabled = ({
  ...
  const adapter = usePickerAdapter();
  return React80.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React81.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
  ...
  const [calendarState, dispatch] = React81.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
  ...
  const onMonthSwitchingAnimationEnd = React81.useCallback(() => {
    dispatch({
...
function usePickerDayOwnerState(parameters) {
  ...
  return React83.useMemo(() => _extends({}, pickerOwnerState, {
    day,
...
var PickersDayRaw = React84.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React84.memo(PickersDayRaw);
if (true)
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime37.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React85.cloneElement(element, {
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React86.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const isOutsideCurrentMonth = React86.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
  ...
  const isFirstVisibleCell = React86.useMemo(() => {
  ...
  const isLastVisibleCell = React86.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React86.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React86.useMemo(() => React86.createRef(), [transitionKey]);
  const weeksToDisplay = React86.useMemo(() => {
  ...
  return (0, import_jsx_runtime38.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime38.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime38.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var MonthCalendarButton = React87.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var MonthCalendar = React88.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const referenceDate = React88.useMemo(
  ...
  const todayMonth = React88.useMemo(() => adapter.getMonth(now), [adapter, now]);
  const selectedMonth = React88.useMemo(() => {
    if (value != null) {
      return adapter.getMonth(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedMonth, setFocusedMonth] = React88.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  const isMonthDisabled = React88.useCallback((dateToValidate) => {
...
var YearCalendarButton = React89.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React90.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const referenceDate = React90.useMemo(
    () => singleItemValueManager.getInitialReferenceValue({
      value,
      adapter,
      props,
  ...
  const todayYear = React90.useMemo(() => adapter.getYear(now), [adapter, now]);
  const selectedYear = React90.useMemo(() => {
    if (value != null) {
      return adapter.getYear(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedYear, setFocusedYear] = React90.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React90.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React90.useRef(null);
...
var PickersArrowSwitcher = React91.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React92.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
  const meridiemMode = getMeridiem(cleanDate, adapter);
  const handleMeridiemChange = React92.useCallback((mode) => {
...
var PickersCalendarHeader = React93.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React94.forwardRef(function DateCalendar2(inProps, ref) {
  const adapter = usePickerAdapter();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React94.useRef(view);
  React94.useEffect(() => {
  ...
  const selectedDays = React94.useMemo(() => [value], [value]);
...
// node_modules/@mui/x-date-pickers/esm/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React96.forwardRef(function DesktopDatePicker2(inProps, ref) {
  var _a;
  const adapter = usePickerAdapter();
...
// node_modules/@mui/x-date-pickers/esm/MobileDatePicker/MobileDatePicker.js
var MobileDatePicker = React99.forwardRef(function MobileDatePicker2(inProps, ref) {
  var _a;
  const adapter = usePickerAdapter();
...
var DatePicker = React100.forwardRef(function DatePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDatePicker"
  });
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OXMVQ2PH.js.map
