      ...
      {cards.map((card, idx) => (
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
            ...
            <Typography variant="h6" sx={{ color: card.color, fontWeight: 600, fontSize: 18 }}>{card.label}</Typography>
          </Box>
          <Typography variant="h3" sx={{ fontWeight: 700, color: '#222', mb: 1, fontSize: 32 }}>{card.value}</Typography>
